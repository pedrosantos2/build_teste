# =============================================================================
# config.py � Conhecimento de dom�nio da migra��o CNPJ alfanum�rico
# Atualize aqui conforme a migra��o evolui. O restante do c�digo n�o muda.
# =============================================================================

# Palavras-chave que identificam vari�veis/colunas relacionadas a CNPJ
PALAVRAS_CNPJ = (
...
# Tabelas que possuem colunas CNPJ (dualidade num�rico/alfanum�rico)
# Quando uma dessas tabelas aparece no c�digo, verificar se as colunas CNPJ est�o corretas
TABELAS_DUALIDADE = {
...
# Mapeamento de colunas legadas ? novas (para valida��o cruzada)
COLUNAS_RENOMEADAS = {
    "cgc_9":              "cgc_r",
    "cgc_4":              "cgc_o",
...
# Sufixos legados (num�rico) vs novos (varchar)
SUFIXOS_LEGADOS = ('_9', '_4', '9', '4')
SUFIXOS_NOVOS   = ('_r', '_o')

# Extens�es de arquivo por tipo
EXTENSOES = {
    "java":     [".java"],
    "forms":    [".fj"],
    "frontend": [".fx", ".jsp"],
...
# Mesmo que apare�am sem o par novo, estao corretas.
